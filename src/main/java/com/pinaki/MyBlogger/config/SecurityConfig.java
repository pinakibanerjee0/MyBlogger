...
import com.pinaki.MyBlogger.security.CustomUserDetailService;
import com.pinaki.MyBlogger.security.JwtAuthenticationEntryPoint;
import com.pinaki.MyBlogger.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeHttpRequests().requestMatchers("/api/v1/auth/login").permitAll().requestMatchers(HttpMethod.GET)
